...
package org.index12306.handler.tokenbucket;
...
import org.index12306.dto.domain.SeatTypeCountDTO;
...
import org.index12306.framework.starter.bases.Singleton;
import org.index12306.framework.starter.cache.DistributedCache;
import org.index12306.framework.starter.common.toolkit.Assert;
import org.index12306.framework.starter.convention.exception.ServiceException;
import org.index12306.mapper.SeatMapper;
import org.index12306.mapper.TrainMapper;
...
public final class TicketAvailabilityTokenBucket {
     ...
     */
    public void rollbackInBucket(org.index12306.remote.dto.TicketOrderDetailRespDTO requestParam) {
