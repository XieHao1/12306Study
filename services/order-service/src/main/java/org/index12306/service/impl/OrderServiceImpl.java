...
import org.index12306.enums.OrderCanalErrorCodeEnum;
import org.index12306.enums.OrderItemStatusEnum;
import org.index12306.enums.OrderStatusEnum;
import org.index12306.entity.OrderDO;
import org.index12306.entity.OrderItemDO;
import org.index12306.entity.OrderItemPassengerDO;
import org.index12306.mapper.OrderItemMapper;
import org.index12306.mapper.OrderMapper;
import org.index12306.dto.domain.OrderStatusReversalDTO;
import org.index12306.dto.req.*;
import org.index12306.dto.resp.TicketOrderDetailRespDTO;
import org.index12306.dto.resp.TicketOrderDetailSelfRespDTO;
import org.index12306.dto.resp.TicketOrderPassengerDetailRespDTO;
import org.index12306.mq.event.DelayCloseOrderEvent;
import org.index12306.mq.event.PayResultCallbackOrderEvent;
import org.index12306.mq.produce.DelayCloseOrderSendProduce;
import org.index12306.remote.UserRemoteService;
import org.index12306.remote.dto.UserQueryActualRespDTO;
import org.index12306.service.OrderItemService;
import org.index12306.service.OrderPassengerRelationService;
import org.index12306.service.OrderService;
import org.index12306.service.orderid.OrderIdGeneratorManager;
import org.index12306.framework.starter.common.toolkit.BeanUtil;
import org.index12306.framework.starter.convention.exception.ClientException;
import org.index12306.framework.starter.convention.exception.ServiceException;
import org.index12306.framework.starter.convention.page.PageResponse;
import org.index12306.framework.starter.convention.result.Result;
import org.index12306.framework.starter.database.toolkit.PageUtil;
